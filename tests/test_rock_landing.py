...
def test_bestmove(fen, description, expected_move=None):
    ...
    response = requests.post(f"{BASE_URL}/bestmove", json={"fen": fen, "maxdepth": 6, "top_n": 3})
...
def main():
    ...
    results.append(test_bestmove(fen="8/8/8/8/3O4/8/3T4/8 w - - 0 1", description="Bestmove works with powered Rook and rock"))
